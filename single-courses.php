...
<?php if ( have_posts() ) while ( have_posts() ) : the_post(); ?>
	...
	<h1><?php the_title(); ?></h1>
		...
		<strong>Title:</strong> <?php print_custom_field('book_title'); ?><br />
		<strong>blurb:</strong> <?php print_custom_field('large_blurb'); ?><br />
		<strong>Belongs To:</strong> <?php print_custom_field('belongs_to:to_link', 'Click here'); ?><br />
