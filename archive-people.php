...
<?php 
 $posts = query_posts($query_string . '&orderby=name_last&order=asc&posts_per_page=-1');
	...
	<td>
		...
		<div class="alignleft">
			<a href="<?php print $post->permalink; ?>">
				<?php print  wp_get_attachment_image($post->photo, array(75,100)); ?>
			</a>
		</div> 
		<a href="<?php print $r->permalink; ?>"><?php print $post->name_first . " " . $r->name_last . ". "; ?></a>
